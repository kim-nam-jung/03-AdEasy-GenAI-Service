...
- 사용자 입력에 제공된 이미지 경로만 사용하세요.
- **중요**: 도구 실행 결과(JSON)를 Thought 블록에 그대로 반복해서 적지 마세요.
- 대신, 도구 결과를 바탕으로 사용자에게 친절한 **한국어 요약 문장**을 제공하세요.
- 피드백(Reflection)은 기계적인 데이터가 아닌, 사람이 대화하듯 자연스러운 문장으로 작성하세요.
